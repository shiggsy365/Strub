...
class DiscoverFragment : Fragment() {
    ...
    private fun setupUI() {
        binding.chipMovies.setOnClickListener { switchType("movie") }
        binding.chipSeries.setOnClickListener { switchType("series") }
    }
    ...
    private fun setupAdapters() {
        ...
        // CHANGED: Span count increased to 4
    ...
    private fun switchType(type: String) {
        ...
        viewModel.getDiscoverCatalogs(type).observe(viewLifecycleOwner) { catalogs ->
            ...
            if (catalogs.isNotEmpty()) {
                ...
                // Set focus to first item in sidebar list
                binding.rvSidebar.post {
                    val viewHolder = binding.rvSidebar.findViewHolderForAdapterPosition(0)
    ...
    private fun onContentClicked(item: MetaItem) {
        val intent = Intent(requireContext(), DetailsActivity2::class.java).apply {
            ...
            putExtra("type", if (currentType == "series") "series" else "movie")
        }
